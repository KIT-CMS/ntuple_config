...
for unc in [
        ...
        "THU_ggH_qmtop"]:
    ggh_theory.append(AddWeight(unc + "Up", Weight("({})".format(unc), "{}_weight".format(unc))))
    ggh_theory.append(AddWeight(unc + "Down", Weight("(1.0/{})".format(unc), "{}_weight".format(unc))))
